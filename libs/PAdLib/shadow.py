...
class Shadow(object):
    ...
    def set_radius(self, radius):
        self.radius = radius
        self.mask = pygame.Surface([rndint(self.radius)*2]*2).convert_alpha()
        self._padlib_needs_update = True
    ...
    def get_mask_and_position(self, c):
        ...
        if self._padlib_needs_update:
            ...
            if not inside:
                pygame.draw.circle(self.mask,c,[rndint(self.radius)]*2,rndint(self.radius),0)
